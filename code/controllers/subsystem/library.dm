...
/*/datum/controller/subsystem/library/proc/prepare_library_areas()
	library_areas = list(
		/area/vtm/masquerade/interior/ground_floor/central/library,
		/area/vtm/masquerade/interior/floor_two/central/library,
		/area/vtm/masquerade/interior/basement/central/library_basement
	)
