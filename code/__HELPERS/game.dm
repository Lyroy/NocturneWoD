...
/proc/AnnounceArrival(mob/living/carbon/human/character, rank)
	...
	deadchat_broadcast("<span class='game'> has arrived at the station at <span class='name'>[A.name]</span>.</span>", "<span class='game'><span class='name'>[character.real_name]</span> ([displayed_rank])</span>", follow_target = character, message_type=DEADCHAT_ARRIVALRATTLE)
