...
/obj/item/paper/employment_contract/Initialize(mapload, new_employee_name)
	...
	and the PENTEX corporation (hereafter referred to as the omnipresent and helpful watcher of humanity).\
	...
	<BR>SLAVE agrees for their corpse to be used by the omnipresent and helpful watcher of humanity as they please, after SLAVE's death. \
