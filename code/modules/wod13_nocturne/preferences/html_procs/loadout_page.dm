/datum/preferences/proc/loadout_page(mob/user, list/dat)
	...
	dat += "<a href='byond://?_src_=prefs;preference=loadout;task=clear_loadout;'>Clear Loadout</a> | <a href='byond://?_src_=prefs;preference=loadout;task=toggle_loadout;'>Toggle Loadout</a></center></b></td></tr>"
