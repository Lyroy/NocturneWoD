...
/datum/vtm_bank_account/proc/modify_balance(amount, mob/living/user = null)
	if(!amount)
		return TRUE
...
/datum/vtm_bank_account/proc/check_pin(mob/living/user, amount, obj/item/source)
...
/datum/vtm_bank_account/proc/process_credit_fraud(mob/living/carbon/human/user, stolen_amt)
